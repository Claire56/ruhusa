...
This document describes the trust model, attacker capabilities, security invariants, known threats, implemented controls, confirmed gaps, and unresolved research questions for Ruhusa at v0.5.0.

This is a frozen snapshot. For ongoing threat model development and future versions, see `docs/threat-model.md`.
...
The package version is `0.5.0` in this frozen release.
